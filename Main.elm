module Main exposing (Action(..), FirebaseModel, Model, config, main, model, runTask, startModel, update, url, view)
...
url =
    "https://elmfire-extra-hello-world.firebaseio.com"
...
update action model =
    ...
    case action of
        ...
        ServerUpdate dict ->
            Dict.foldl reduceKeyValue "" dict
